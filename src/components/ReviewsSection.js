...
const REVIEWS = [
  ...
  {
    rating: 5,
    text: "The company that helped us with solar panel installation. Imran Khan, the owner is very professional and made sure the project was right on schedule. Right now we are enjoying the benefits of clean energy plus we are saving money out of it. I would highly recommend Vibes Energy Solar for your solar panel installation needs.",
  ...
  {
    rating: 5,
    text: "As the owner of a remote off grid property in northern Manitoba I can say that Imran exceeded all of our expectations in every way. Superb advice state of the art equipment and amazing support as I self installed my hybrid solar system. Everything works as advertised and the days of internal combustion powered energy are over for us. We are saving thousands of dollars annually by going solar, you can too! Thanks again Imran. 5 out of 5 stars",
    author: "— Tall Pines Lodge, Winnipeg"
  },
  {
    rating: 5,
  ...
  {
    rating: 5,
    text: "Vibes Energy was fantastic to work with! They were always quick to respond and were very knowledgeable. If you're looking to install solar panels in the future, I wholeheartedly recommend Vibes Energy!",
    author: "— Tall Pines Lodge, Winnipeg"
  },
]
    ...
    <section className="reviews-section">
      <div className="container">
        <div className="d-flex justify-content-between align-items-center mb-5">
          <h2 className="reviews-title" style={{maxWidth:400}}>WHAT CUSTOMERS ARE SAYING</h2>
